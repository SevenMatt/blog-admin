...
class Admin::ProjectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_project" do
    assert_difference("Admin::Project.count") do
      post admin_projects_url, params: { admin_project: { description: @admin_project.description, media: @admin_project.media, title: @admin_project.title } }
    end
  ...
  test "should update admin_project" do
    patch admin_project_url(@admin_project), params: { admin_project: { description: @admin_project.description, media: @admin_project.media, title: @admin_project.title } }
